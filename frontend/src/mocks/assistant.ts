import {
  PagesContentResponseData,
  PagesStructureResponseData,
} from '~/services/api/assistant/assistant.types';

// ==================================
// Mocked Pages Structure Data
// ==================================
export const mockPagesStructureResponse: PagesStructureResponseData = {
...
// ==================================
export const mockPagesContentResponse: PagesContentResponseData = {
  title: 'Intelligence Artificielle',
  description:
    'Cours généré automatiquement sur le thème: Intelligence Artificielle',
  pages: [
