...
export const Index = () => {
  ...
  const handleOnTreeItemClick = (pageId: ID) => {
    const page = treeData.find((page) => page.id === pageId);
    // if page content is generated by AI but the content is not ready yet, do nothing
    if (page?.aiMetadata && !page?.aiMetadata.contentGenerated) {
      return;
    }
    // else go to the page
